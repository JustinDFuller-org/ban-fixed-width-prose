...
- Extend stable-tag release CI to publish the matching npm version through npm trusted publishing with GitHub Actions OIDC.
...
- Retain GitHub Action release behavior and the existing v1 major-tag update.
...
- Adds npm registry publication as an external release system and requires one-time npm trusted-publisher configuration for the repository's release workflow.
